...
icon = PhotoImage(file=r'Calculator keys\Icon.png')
...
one_button = PhotoImage(file=r'Calculator keys\one.png')
two_button = PhotoImage(file=r'Calculator keys\2.png')
three_button = PhotoImage(file=r'Calculator keys\3.png')
four_button = PhotoImage(file=r'Calculator keys\4.png')
five_button = PhotoImage(file=r'Calculator keys\5.png')
six_button = PhotoImage(file=r'Calculator keys\6.png')
seven_button = PhotoImage(file=r'Calculator keys\7.png')
eight_button = PhotoImage(file=r'Calculator keys\8.png')
nine_button = PhotoImage(file=r'Calculator keys\9.png')
zero_button = PhotoImage(file=r'Calculator keys\0.png')
plus_img = PhotoImage(file=r'Calculator keys\pluselong.png')
minus_img = PhotoImage(file=r'Calculator keys\minus.png')
div_img = PhotoImage(file=r'Calculator keys\div.png')
mul_img = PhotoImage(file=r'Calculator keys\mult.png')
clear_img = PhotoImage(file=r'Calculator keys\c.png')
del_img = PhotoImage(file=r'Calculator keys\Del.png')
equal_img = PhotoImage(file=r'Calculator keys\equalelong.png')
point_img = PhotoImage(file=r'Calculator keys\point.png')
