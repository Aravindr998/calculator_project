...
button_one = Button(window, image=one_button, width=60, height=60, command=display_one, borderwidth=0)
button_two = Button(window, image=two_button, width=60, height=60, command=display_two, borderwidth=0)
button_three = Button(window, image=three_button, width=60, height=60, command=display_three, borderwidth=0)
button_four = Button(window, image=four_button, width=60, height=60, command=display_four, borderwidth=0)
button_five = Button(window, image=five_button, width=60, height=60, command=display_five, borderwidth=0)
button_six = Button(window, image=six_button, width=60, height=60, command=display_six, borderwidth=0)
button_seven = Button(window, image=seven_button, width=60, height=60, command=display_seven, borderwidth=0)
button_eight = Button(window, image=eight_button, width=60, height=60, command=display_eight, borderwidth=0)
button_nine = Button(window, image=nine_button, width=60, height=60, command=display_nine, borderwidth=0)
button_zero = Button(window, image=zero_button, width=60, height=60, command=display_zero, borderwidth=0)
clear_button = Button(window, image=clear_img, width=60, height=60, command=clear, borderwidth=0)
plus_button = Button(window, image=plus_img, width=60, height=124, command=display_plus, borderwidth=0)
minus_button = Button(window, image=minus_img, width=60, height=60, command=display_minus, borderwidth=0)
mult_button = Button(window, image=mul_img, width=60, height=60, command=display_mult, borderwidth=0)
div_button = Button(window, image=div_img, width=60, height=60, command=display_div, borderwidth=0)
equal_button = Button(window, image=equal_img, width=60, height=124, command=display_equal, borderwidth=0)
point_button = Button(window, image=point_img, width=60, height=60, command=display_point, borderwidth=0)
del_button = Button(window, image=del_img, width=60, height=60, command=delete, borderwidth=0)
...
label = Label(window, text="", bg="#303030", fg="white", width=38, height=4, anchor=E)
